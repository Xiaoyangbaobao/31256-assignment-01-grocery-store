...
const ShopDetailsMain = ({ id }: any) => {
  ...
  const handleAddToCart = (product?: CartProductType) => {
    if (!product) return;
    if ( totalCart && totalCart >= product.productQuantity) {
      toast.info("The product is out of stock, you cannot increase");
      return;
    }
                            ...
                            <ul>
                              <li>
                                <span
                                  ...
                                  title="Wishlist"
                                  onClick={() =>
                                    myProduct && dispatch(wishlist_product(myProduct))
                                  }
                                >
